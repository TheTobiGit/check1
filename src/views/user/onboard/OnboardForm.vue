<template>
  <section class="h-full flex flex-col items-center gap-[5vh]">
    <div class="h-[10vh] md:h-[20vh]">
      <img src="../../../assets/logoo.png" alt="" class="h-full" />
    </div>
    <form
      @submit.prevent="handleClick"
      class="w-[80vw] md:w-auto border border-black rounded-md shadow-md flex flex-col gap-5 p-5"
    >
      ...
      <div class="flex flex-col gap-2 capitalize">
        ...
        <input
          v-model="userName"
          type="text"
          class="w-full md:max-w-[40vw] px-4 py-2 border border-black shadow-md rounded-md text-slate-400"
          required
          disabled
        />
      </div>
      ...
      <div class="flex flex-col gap-2 capitalize">
        <label for="number" name="number">{{ labels[2] }}</label>
        <input
          v-model="userNumber"
          type="tel"
          placeholder="Enter your phone number..."
          :class="{ 'border-red-500': error }"
          class="w-full md:max-w-[40vw] px-4 py-2 border border-black shadow-md rounded-md"
          required
        />
      ...
      <button
        class="w-[25vw] md:w-[10vw] px-4 py-2 bg-[#2a5198] text-white capitalize self-center rounded-md"
        type="submit"
...
export default {
  setup() {
    const title = ref("update profile");
    const labels = ref([
      "name",
      "student / staff iD",
      "phone number",
    ...
    const defaultOption = ref("Choose your department");
